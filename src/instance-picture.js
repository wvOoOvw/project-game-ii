...
class Picture {
  constructor() {
    this.map = {
      ...
      'monster-1': I_aiyafala37be7922,

      'witch-1': I_chenb65023b5,
      'witch-skill-1': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-2': I_cuoec908ed3c,
      'witch-skill-2': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-3': I_fengdi72b31ee1,
      'witch-skill-3': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-4': I_hei6cc6018a,
      'witch-skill-4': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-5': I_heijiane5f9b0d1,
      'witch-skill-5': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-6': I_huanga3fc17ce,
      'witch-skill-6': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-7': I_kongxiande9b3926,
      'witch-skill-7': [I_yanwei29b3239c, I_yifulite8bc864d4],

      'witch-8': I_linguangacf5bd67,
      'witch-skill-8': [I_yanwei29b3239c, I_yifulite8bc864d4],
    }
  }
